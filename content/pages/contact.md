...
<form id="fs-frm" name="simple-contact-form" accept-charset="utf-8" action="https://formspree.io/f/xgenedzv" method="post">
  <fieldset id="fs-frm-inputs">
    ...
    <textarea rows="5" name="message" id="message" placeholder="Type you message here." required=""></textarea>
...
You can use also use Bandcamp's contact from to send me message.
